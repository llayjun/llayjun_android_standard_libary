...
public class PhoneUtil {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) SUtils.getApp()
     ...
     */
    public static void openDialboard(String phoneNumber) {
     ...
     * @param content     短信内容
     */
    public static void openSmsBoard(String phoneNumber, String content) {
    ...
    public static void sendSms(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(SUtils.getApp(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = SUtils.getApp().getContentResolver();
