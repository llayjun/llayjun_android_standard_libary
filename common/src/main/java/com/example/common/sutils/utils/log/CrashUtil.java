package com.example.common.sutils.utils.log;
...
public class CrashUtil implements Thread.UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
             ...
             */
            mInfos.put("手机型号", Build.MODEL);
            mInfos.put("系统版本", Build.VERSION.SDK + "");
            mInfos.put("Android版本", Build.VERSION.RELEASE);
            mInfos.put("手机系统定制商", Build.BRAND);
            mInfos.put("手机硬件制造商", Build.MANUFACTURER);
