...
public class CircleProgressBar extends AppCompatImageView {
    ...
    private static final int DEFAULT_CIRCLE_LIGHT = Color.parseColor("#b7b7b7");
...
//        </attr>
        ...
        mProgressColor = a.getColor(R.styleable.CircleProgressBar_mlpb_progress_color, DEFAULT_CIRCLE_LIGHT);
