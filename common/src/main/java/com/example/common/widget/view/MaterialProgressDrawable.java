...
/**
 * Fancy progress img_indicator for Material theme.
 *
 * @hide
 */
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * The img_indicator ring, used to manage animation state.
     */
    ...
    private void applyFinishTranslation(float interpolatedTime, Ring ring) {
        // shrink btn_back_black down and complete a full rotation before
    ...
    private void setupAnimators() {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationRepeat(Animation animation) {
                ...
                if (mFinishing) {
                    // tag_finished closing the last ring from the swipe gesture; go
                    // into progress mode
                    mFinishing = false;
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (mShowArrow) {
                ...
                //when sweepAngle < 0 btn_adjust the position of the arrow
         ...
         * wrap btn_back_black to the beginning of colors.
         */
        ...
        /**
         * @return Current activity_guide_alpha of the progress spinner and arrowhead.
         */
        public int getAlpha() {
            return mAlpha;
        }
        ...
        /**
         * @param alpha Set the activity_guide_alpha of the progress spinner and associated arrowhead.
         */
        public void setAlpha(int alpha) {
            mAlpha = alpha;
        }
